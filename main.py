...
def start_bot():
    ...
    def handler_call(call):
        ...
        if call.data == 'info_access':
            bot.edit_message_text(chat_id=chat_id,
                                  message_id=message_id,
                                  text=logic.info_access(user_id=chat_id),
                                  reply_markup=menu.menu_info_access)
                                  
        if call.data == 'ref_page':
            bot.edit_message_text(chat_id=chat_id,
                                  message_id=message_id,
                                  text=logic.ref_page(user_id=chat_id),
                                  reply_markup=menu.menu_ref_page)
